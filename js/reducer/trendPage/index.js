...
export default function onAction(state = {}, action) {//只有在undefined时，都会触发取默认参数
    ...
    switch (type) {
        case types.TRENDING_REQUEST_DATA:
        ...
        case types.TRENDING_REFRESH_DATA_SUCCESS:
        ...
        case types.TRENDING_REFRESH_DATA_Fail:
            /*return Object.assign({}, state, {
        ...
        case types.TRENDING_LOAD_MORE_DATA:
            return {
                ...state,
                [tabName]:{
                    ...state[tabName],
        ...
        case types.TRENDING_LOAD_MORE_DATA_SUCCESS:
            return {
                ...state,
                [tabName]:{
                    ...state[tabName],
        ...
        case types.TRENDING_LOAD_MORE_DATA_Fail:
            return {
                ...state,
                [tabName]:{
                    ...state[tabName],
